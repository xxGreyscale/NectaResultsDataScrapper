...
class NectaCSEEResult:
    def __init__(self,
                 ...
                 index_number: str,
                 year: int,
                 subjects: list[CSEESubjectAndGrade],
                 division: DivisionEnum = None,
                 created_at: datetime = None,
                 updated_at: datetime = None,
                 ):
        ...
        self._validate_subject(subjects)
        self.subjects: list[CSEESubjectAndGrade] = subjects
    ...
    @staticmethod
    def _validate_subject(subjects: list[CSEESubjectAndGrade]):
        """"
        There should not be more than one subject with the same name
        """
        seen_subjects = set()
